      ...
      <div className="max-w-[1400px] w-full mx-auto grid md:grid-cols-2 gap-16 items-center relative z-10">
        ...
        <div className="animate-[fadeInLeft_1s_ease] text-center md:text-left">
          ...
          {personalInfo.availableForWork && (
            <Badge variant="success" className="mb-6 animate-[pulse_2s_infinite]">
              <span className="w-2 h-2 bg-accent rounded-full animate-[blink_1.5s_infinite]"></span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-8">
            {personalInfo.stats.map((stat, index) => (
              <div
                key={index}
                className="bg-dark-card p-5 rounded-xl border border-border transition-all duration-300 hover:-translate-y-1.5 hover:border-primary hover:shadow-[0_10px_30px_rgba(0,217,255,0.2)]"
              >
